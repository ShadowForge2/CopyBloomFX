"""
Simple Migration Fix - Run this from the django_crypto directory
"""
import os
import sys
import django
...
def main():
    ...
    try:
        ...
        if not CustomUser.objects.filter(username='admin').exists():
            print("  ⚠️  Admin user not found. Please create manually:")
        ...
        print("  3. The 'last_daily_profit_at' error should be resolved")
