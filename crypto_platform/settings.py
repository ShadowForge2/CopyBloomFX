...
try:
    env_path = BASE_DIR / 'local_env.txt'
    if env_path.exists():
        ...
        print("DEBUG: Local environment loaded successfully")
    else:
        print("DEBUG: Local environment file not found")
except Exception as e:
    print(f"DEBUG: Local environment loading failed: {e}")
...
MIDDLEWARE = [
    ...
    'crypto.middleware.AdminSessionTimeoutMiddleware',
]
