...
class Profile(models.Model):
    ...
    referrer = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='referred_profiles')
    ...
    def get_referral_stats(self):
        ...
        # Filter referrals where the referee has a positive principal balance
        active_referrals = self.user.referrals_made.filter(
            referee__profile__locked_balance__gt=0
        ).count()
